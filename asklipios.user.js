...
//
// @require      https://raw.githubusercontent.com/VectorPerkins1/Asklipios-Userscript/main/src/00-namespace.js?v=0.2.0
...
(function () {
    ...
    console.log('Asklipios Modular loader 0.2.0 loaded');
